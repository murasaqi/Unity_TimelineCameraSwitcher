...
public class TimelineCameraSwticherBehaviour : PlayableBehaviour
{
    ...
    private TimelineCameraSwticherTrack m_track;
    ...
    internal TimelineCameraSwticherTrack track
    {
        get { return m_track; }
        set { m_track = value; }
    }
    ...
    private CameraSwitcherBrain m_TrackBinding;
    ...
    {
        m_TrackBinding = playerData as CameraSwitcherBrain;
       ...
       var timelineAsset = director.playableAsset as TimelineAsset;
        ...
        {
            var scriptPlayable =  (ScriptPlayable<TimelineCameraSwitcherBehaviour>)playable.GetInput(i);
        ...
        foreach (TimelineClip clip in m_Clips)
        {
            ...
            var scriptPlayable =  (ScriptPlayable<TimelineCameraSwitcherBehaviour>)playable.GetInput(inputPort);
            var playableBehaviour = scriptPlayable.GetBehaviour();
    ...
    public Vector4 CalcNoise(TimelineCameraSwitcherBehaviour a, TimelineCameraSwitcherBehaviour b, float currentTime)
    {
